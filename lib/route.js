...
Route.prototype.put = function() {
	var callWith = ['put'].concat(Array.prototype.slice.call(arguments));
...
Route.prototype.post = function() {
	var callWith = ['post'].concat(Array.prototype.slice.call(arguments));
...
Route.prototype.delete = function() {
	var callWith = ['delete'].concat(Array.prototype.slice.call(arguments));
